...
const WhatCanIDo = () => {
  ...
  return (
    <WhatCanIDoWr>
      <TitleCanIDO firstRow={'About'} secondRow={'me'}/>
      <TextCanIDo
        row1={`Я обладаю широким спектром интересов в области разработки программного обеспечения`}
        row2={`В своей работе я стремлюсь найти баланс между инженерными аспектами, связанными`}
        row3={`с разработкой программного обеспечения и управлением проектами, так и творческими аспектами`}
        row4={`Программирование и непрерывное обучение в этой области позволяют мне быть адаптированным и актуальным.`}
      />
